...
| 기능    | 메서드    | Endpoint                | 설명                  | 요청 항목 예시                                                                  | 응답 코드 및 설명                               |
|-------|--------|-------------------------|---------------------|---------------------------------------------------------------------------|------------------------------------------|
| 작성    | POST   | `/api/dreams`           | 꿈 일기 작성             | `dreamDate`, `content`, `emotionTags`, `isPublic`, `aiSuggestedTags (선택)` | `201 Created`: 등록 성공<br>`400/401`: 오류    |
| 목록 조회 | GET    | `/api/dreams`           | 나의 꿈 일기 목록 조회 (페이징) | `page`, `size`, `sort` (query param)                                      | `200 OK`: 목록 반환<br>`401`: 인증 오류          |
| 상세 조회 | GET    | `/api/dreams/{dreamId}` | 특정 꿈 일기 조회          | Path: `dreamId`                                                           | `200 OK`<br>`401/403/404`: 인증/권한/존재 오류   |
| 수정    | PUT    | `/api/dreams/{dreamId}` | 꿈 일기 수정             | Path: `dreamId`, Body: 변경 필드                                              | `200 OK`<br>`400/401/403/404`: 수정 실패     |
| 삭제    | DELETE | `/api/dreams/{dreamId}` | 꿈 일기 삭제             | Path: `dreamId`                                                           | `204 No Content`<br>`401/403/404`: 삭제 실패 |
